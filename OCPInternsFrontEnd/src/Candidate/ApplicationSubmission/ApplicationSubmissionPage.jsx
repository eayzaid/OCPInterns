...
export default function ApplicationSubmissionPage(){
    ...
    const onSubmit = async ()=>{
        ...
        const response = await submitApplicaiton( accessToken , { ...application , fullName } );
    ...
    return(
        <div className="flex-1 flex justify-center items-center">
            ...
            <div>
                <Label className="text-white text-2xl lg:text-3xl mb-1">General informations about your Internship</Label>
                <div className="bg-gray-300 rounded-sm p-4">
                    <GeneralInfo onAction={submit}  isValid={ valid } setGeneralInfo={(toBeAdded) => { setApplication({...application , generalInfo : toBeAdded}) }}/>
                </div>
            </div>
                <div>
                    <Label className="text-white text-2xl lg:text-3xl">Add your Education</Label>
                    <div  className="w-full h-auto flex flex-row flex-wrap gap-1 mt-2 p-2 rounded-xs bg-gray-500">
                            ...
                            application.education.map( (element , idx) =>{
                                return (
                                    <EducationForm
                                        key={idx}
                                        education={element}
                                        addApplication={(updatedElement) => setApplication(prev => ({
                                            ...prev,
                                            education: prev.education.map((item, i) =>
                                                i === idx ? updatedElement : item
                                            )
                                        }))}
                                        deleteApplication={() => setApplication(prev => ({
                                            ...prev,
                        ...
                        <EducationForm addApplication={(newElement) => setApplication(prev => ({
                            ...prev,
                ...
                <div>   
                    <Label className="text-white text-2xl lg:text-3xl">Add your Experiences</Label>
                    <div  className="w-full h-auto flex flex-row flex-wrap gap-1 mt-2 p-2 rounded-xs bg-gray-500">
                        {
                        ...
                        <ExperienceForm addApplication={(newElement) => setApplication(prev => ({
                            ...prev,
                ...
                <div>
                    <Label className="text-white text-2xl lg:text-3xl">Add your Skills</Label>
                    <div  className="w-full h-auto flex flex-row flex-wrap gap-1 mt-2 p-2 rounded-xs bg-gray-500">
                        {
                        ...
                        <SkillForm addApplication={(newElement) => setApplication(prev => ({
                            ...prev,
                ...
                <div>
                    <Label className="text-white text-2xl lg:text-3xl">Add your Languages</Label>
                    <div  className="w-full h-auto flex flex-row flex-wrap gap-1 mt-2 p-2 rounded-xs bg-gray-500">
                        {
                        ...
                        <LanguageForm addApplication={(newElement) => setApplication(prev => ({
                            ...prev,
                ...
                <div className="flex justify-between gap-2 flex-col md:flex-row ">
                        <Button onClick={onSubmit} variant="secondary">Add</Button>
